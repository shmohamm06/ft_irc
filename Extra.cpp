...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/18 13:49:32 by shmohamm          #+#    #+#             */
/*   Updated: 2024/12/18 13:49:33 by shmohamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int processMessageWithProfanityCheck(int userFd, const std::string& message) {
    ...
    if (detectProfanity(message, detectedWord)) {
        ...
        // Log the infraction
        std::ofstream logtracker("log.txt", std::ios::app);
        if (logtracker.is_open()) {
            logtracker << "User " << nickname << " sent profanity: " << detectedWord << "\n";
            logtracker.close();
        } else {
